...
<div id="overlay">
  <div id="inst-contact-container">
    ...
    <div id="inst-form-container">
      <div id="inst-form-exit-container"><i id="inst-form-exit" class="icon-remove-circle icon-2x"></i></div>
      <form name="form10" action="/about/institutional" method="post" id="inst-form" enctype="multipart/form-data">
        <label for="1_element13">Name: </label>
        <input type="hidden" id="counter13" value="5" name="counter13">
        <input type="hidden" value="type_text" name="1_type13" id="1_type13">
        <input type="hidden" value="no" name="1_required13" id="1_required13">
        <input type="hidden" value="no" name="1_unique13" id="1_unique13">
        <input type="text" class="input_deactive" id="1_element13" name="1_element13" value="" title="" onfocus="delete_value('1_element13')" onblur="return_value('1_element13')" onchange="change_value('1_element13')" style="width: 200px;">
        <label for="2_element13">Email Address: </label>
        <input type="hidden" value="type_text" name="2_type13" id="2_type13">
        <input type="hidden" value="no" name="2_required13" id="2_required13">
        <input type="hidden" value="no" name="2_unique13" id="2_unique13">
        <input type="text" class="input_deactive" id="2_element13" name="2_element13" value="" title="" onfocus="delete_value('2_element13')" onblur="return_value('2_element13')" onchange="change_value('2_element13')" style="width: 200px;">
        <span class="warning"><i class="icon-remove" style="display:none;color:red;"></i></span>
        <label for="3_element13">Institution Type: </label>
        <input type="hidden" value="type_text" name="3_type13" id="3_type13">
        <input type="hidden" value="no" name="3_required13" id="3_required13">
        <input type="hidden" value="no" name="3_unique13" id="3_unique13">
        <input type="text" class="input_deactive" id="3_element13" name="3_element13" value="" title="" onfocus="delete_value(&quot;3_element13&quot;)" onblur="return_value(&quot;3_element13&quot;)" onchange="change_value(&quot;3_element13&quot;)" style="width: 200px;">
        <button type="submit" id="4_element_submit13" value="Submit">Submit</button>
      </form>
      <div id="form-sending">
